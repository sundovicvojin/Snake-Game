...
def gameOver():
    canvas.delete(ALL)
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2, font=("consolas", 70), text="GAME OVER", fill=FOOD_COLOR, tag="gameover")
...
label = Label(window, text="Score={}".format(score), font=('consolas', 24))
label.pack()
